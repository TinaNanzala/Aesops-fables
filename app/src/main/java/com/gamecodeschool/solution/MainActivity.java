package com.gamecodeschool.solution;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnFable1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
             startActivity(new Intent(getBaseContext(),Fable1_Activity.class));
        ...
        btnFable2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getBaseContext(),Fable2_Activity.class));
        ...
        btnFable3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getBaseContext(),Fable3_Activity.class));

            }
        });   btnFable4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getBaseContext(),Fable4_Activity.class));
        ...
        btnFable5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getBaseContext(),Fable5_Activity.class));
        ...
        btnFable6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getBaseContext(),Fable6_Activity.class));
        ...
        btnFable7.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getBaseContext(),Fable7_Activity.class));
        ...
        btnFable8.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getBaseContext(),Fable8_Activity.class));
        ...
        btnFable9.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getBaseContext(),Fable9_Activity.class));
        ...
        btnFable10.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getBaseContext(),Fable10_Activity.class));
